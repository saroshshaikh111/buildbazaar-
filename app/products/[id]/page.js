    ...
    useEffect(() => {
        async function fetchProduct() {
            ...
            try {
                ...
                if (data.id === 'p1') {
                    // Guaranteed-load High-Fidelity material image (Concrete/Blocks)
                    updatedProduct.images = ['https://images.unsplash.com/photo-1620067925053-40001c440c6b?auto=format&fit=crop&q=80&w=1000'];
