                                            ...
                                            <div className="product-footer" style={{marginTop: '1rem'}}>
                                                <div className="price-container">
                                                    <div className="price-current">
                                                        Γé╣{prod.priceCurrent.toLocaleString('en-IN')}
                                                        {prod.priceOld && <span className="price-old">Γé╣{prod.priceOld.toLocaleString('en-IN')}</span>}
                                                    </div>
                ...
                <section id="how-it-works" className="py-16 dark-section">
                    <div className="container">
                        ...
                        <div className="section-header text-center w-full">
                            <h2>How It Works</h2>
                            <p>From browsing to building ΓÇö simplified in four easy steps.</p>
                        </div>
            ...
            <div className={`cart-drawer ${cartDrawerOpen ? 'active' : ''}`}>
                        ...
                        cart.map(item => (
                            <div className="cart-item" key={item.id}>
                                <div className="cart-item-info">
                                    ...
                                    <div className="cart-item-price">Γé╣{item.priceCurrent.toLocaleString('en-IN')} x {item.quantity} = Γé╣{(item.priceCurrent * item.quantity).toLocaleString('en-IN')}</div>
                ...
                <div className="cart-footer">
                    <div className="cart-summary flex-between">
                        ...
                        <span className="total-price">Γé╣{totalPrice.toLocaleString('en-IN')}</span>
                    </div>
